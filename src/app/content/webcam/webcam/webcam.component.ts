...
export class WebcamComponent implements AfterViewInit, OnDestroy {
  ...
  /** definir largeur de webcam en px */
  @Input() public width: number = 300;
  /** definir hauteur de webcam en px  */
  @Input() public height: number = 300;
  /** Si l’Observable représenté par cet subscription emit, une image sera capturée et émise via
   * EventEmitter 'imageCapture' */
  private triggerSubscription: Subscription;
  /** définir  base constraints sera appliqué  lors de la demande de  vidéo à partir de UserMedia*/
  @Input() public videoOptions: MediaTrackConstraints = WebcamComponent.DEFAULT_VIDEO_OPTIONS;
  /** Drapeau pour activer / désactiver le commutateur de caméra. Si activé, une icône de commutateur sera affichée si plusieurs caméras ont été trouvées */
